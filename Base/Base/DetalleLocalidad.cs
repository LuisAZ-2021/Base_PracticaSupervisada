...
namespace Base
{
    public partial class DetalleLocalidad : Form
    {
            ...
            try
            {
                using (SqlConnection conector = new SqlConnection(conString))
                {
                    ...
                    foreach (DataGridViewColumn column in dataGridView1.Columns)
                    {
                        ...
                        // Reemplaza los corchetes en el nombre de la columna
        ...
        private void DetalleLocalidad_Load(object sender, EventArgs e)
        {
            Mostrar();
        ...
        //######################################################################################################
        //
        // A partir de Aca Funcionalidad de CLickDerecho
        //
        //######################################################################################################
        ...
        // Método para verificar si una columna es de tipo numérico
